        ...
        <div class="row gy-4 justify-content-center">
            ...
            <div class="row">
                ...
                <ul>
                    ...
                    <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.milan-vanwinkel-statweb.be/portfolio</span></li>
                ...
                <div class="col-lg-6">
                <ul>
                    <li><i class="bi bi-chevron-right"></i> <strong>Leeftijd:</strong> <span>19</span></li>
